...
void DeferredShaderScene::Load()
{
	...
	HS_Engine::Object* object = new HS_Engine::Object("bunnyDynamic", "bunny", "Common/models/bunny.obj", E_MeshTypes::BY_PATHMESH, E_RenderTypes::TRIANGLES);
	...
	object = new HS_Engine::Object("SphereDynamic", "bunny", "Common/models/bunny.obj", E_MeshTypes::BY_PATHMESH, E_RenderTypes::TRIANGLES);
	object->SetShader(m_Shader_PhongShading);
	object->SetShaderForDebug(m_Shader_Debug);
	object->SetEnvironmentMapping(true);
	object->SetPosition({ 0.f, 0.f, 0.f });
	...
	object = new HS_Engine::Object("bunny1", "bunny", "Common/models/bunny.obj", E_MeshTypes::BY_PATHMESH, E_RenderTypes::TRIANGLES);
	object->SetShader(m_Shader_PhongShading);
	object->SetShaderForDebug(m_Shader_Debug);
	//object->SetEnvironmentMapping(true);
	object->SetPosition({ 0.f, 0.f, 0.f });
...
void DeferredShaderScene::Update(double dt)
{
	...
	//mObjectManager.EnvironmentMapping([&](HS_Engine::Camera& save)
	//	{
	...
	//		mObjectManager.RenderAllForFrameBuffer(dt);
...
void DeferredShaderScene::UnLoad()
{
	HS_Engine::ObjectManager& mObjectManager = HS_Engine::Engine::GetObjectManager();
...
void DeferredShaderScene::ImGuiUpdate()
{
	HS_Engine::ObjectManager& mObjectManager = HS_Engine::Engine::GetObjectManager();
	...
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyTopFrame")->GetTextureID(), ImVec2(200, 200), ImVec2(1, 1), ImVec2(0, 0));
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyFrontFrame")->GetTextureID(), ImVec2(200, 200),ImVec2(-1,1),ImVec2(0,0));
	//	ImGui::SameLine();
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyLeftFrame")->GetTextureID(), ImVec2(200, 200), ImVec2(-1, 1), ImVec2(0, 0));
	//	ImGui::SameLine();
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyBackFrame")->GetTextureID(), ImVec2(200, 200), ImVec2(-1, 1), ImVec2(0, 0));
	//	ImGui::SameLine();
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyRightFrame")->GetTextureID(), ImVec2(200, 200), ImVec2(-1, 1), ImVec2(0, 0));
	//	ImGui::SetCursorPos(ImVec2(210, 400));
	//	ImGui::Image((void*)(intptr_t)mTextureManager.GetTexture("bunnyBottomFrame")->GetTextureID(), ImVec2(200, 200), ImVec2(1, 1), ImVec2(0, 0));
	//}
	//ImGui::End();
...
void DeferredShaderScene::processInput(HS_Engine::Window* window, double dt)
{
